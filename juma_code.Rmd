...
$$
\log\left(\frac{P(Y = \text{Mostly B's})}{P(Y = \text{Mostly A's})} \right) = 
  0.8634 + \\
...
# Models Comparisons
```{r}
# Extract Accuracy, Kappa, and AUC for each model
...
3. Limited Generalizability: The dataset may not represent all schools or demographic groups, affecting external validity.
